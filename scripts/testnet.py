...
def main():
    ...
    StargateTokenContract = StargateToken.deploy(\
        ...
        config.testnetEndpoint["goerli"]["endpoint"], \
    ...
    #     {"from": accounts.load("0")}
    # )
    # StargateToken.deploy("stg", "stg", "0x7dcAD72640F835B0FA36EFD3D6d3ec902C7E5acf", 10001, 100000000000000000000, {"from": accounts.load("0")})
